function [trainedModel, validationRMSE] = Output_1_LR(trainingData, responseData)
...
% Auto-generated by MATLAB on 31-Oct-2022 15:10:33
...
inputTable = array2table(trainingData, 'VariableNames', {'Concentration ratio', 'Ele Con p-type', 'Ele Con n-type', 'Seeb Coefficient p-type', 'Seeb Coefficient n-type', 'Thermal conductivity p-type', 'Thermal conductivity n-type', 'RL'});

predictorNames = {'Concentration ratio', 'Ele Con p-type', 'Ele Con n-type', 'Seeb Coefficient p-type', 'Seeb Coefficient n-type', 'Thermal conductivity p-type', 'Thermal conductivity n-type', 'RL'};
...
concatenatedPredictorsAndResponse.Train_Output1 = response;
linearModel = fitlm(...
...
concatenatedPredictorsAndResponse.Train_Output1 = trainingResponse;
linearModel = fitlm(...
    concatenatedPredictorsAndResponse, ...
    'interactions', ...
    'RobustOpts', 'off');
